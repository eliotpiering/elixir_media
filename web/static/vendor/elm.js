...
var _user$project$AlbumArt$view = function (picture) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('album-art-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src(picture)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$MyModels$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {currentSong: a, browser: b, queue: c, albumArt: d, currentMousePos: e, dragStart: f, keysBeingTyped: g, isShiftDown: h};
	});
var _user$project$MyModels$SongModel = F6(
	function (a, b, c, d, e, f) {
		return {id: a, path: b, title: c, artist: d, album: e, track: f};
	});
var _user$project$MyModels$GroupModel = F2(
	function (a, b) {
		return {title: a, songs: b};
	});
var _user$project$MyModels$QueueModel = F3(
	function (a, b, c) {
		return {array: a, mouseOver: b, mouseOverItem: c};
	});
var _user$project$MyModels$BrowserModel = F2(
	function (a, b) {
		return {isMouseOver: a, items: b};
	});
var _user$project$MyModels$ItemModel = F3(
	function (a, b, c) {
		return {isSelected: a, isMouseOver: b, data: c};
	});
var _user$project$MyModels$Group = function (a) {
	return {ctor: 'Group', _0: a};
};
var _user$project$MyModels$Song = function (a) {
	return {ctor: 'Song', _0: a};
};
var _user$project$MyModels$OtherWindow = {ctor: 'OtherWindow'};
var _user$project$MyModels$QueueWindow = {ctor: 'QueueWindow'};
var _user$project$MyModels$BrowserWindow = {ctor: 'BrowserWindow'};
...
var _user$project$ApiHelpers$songDecoder = A7(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'album', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'track', _elm_lang$core$Json_Decode$int));
var _user$project$ApiHelpers$songsDecoder = A2(
	_elm_lang$core$Json_Decode_ops[':='],
	'songs',
	_elm_lang$core$Json_Decode$list(_user$project$ApiHelpers$songDecoder));
var _user$project$ApiHelpers$groupDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
...
var _user$project$ApiHelpers$fetchAllSongs = F2(
	function (failAction, successAction) {
		var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$ApiHelpers$apiEndpoint, 'songs');
		return A3(
			_elm_lang$core$Task$perform,
			failAction,
			successAction,
			A2(_evancz$elm_http$Http$get, _user$project$ApiHelpers$songsDecoder, url));
	});
var _user$project$ApiHelpers$fetchAllArtists = F2(
	function (failAction, successAction) {
		...
		return A3(
			...
			failAction,
			successAction,
			A2(_evancz$elm_http$Http$get, _user$project$ApiHelpers$artistsDecoder, url));
	});
var _user$project$ApiHelpers$fetchAllAlbums = F2(
	function (failAction, successAction) {
		...
		return A3(
			...
			failAction,
			successAction,
			A2(_evancz$elm_http$Http$get, _user$project$ApiHelpers$albumsDecoder, url));
	});
				...
				return _elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							{ctor: '_Tuple2', _0: 'left', _1: xPos},
							{ctor: '_Tuple2', _0: 'top', _1: yPos},
...
var _user$project$MyStyle$queueViewContainer = function (canDrop) {
	return canDrop ? _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'border', _1: 'solid black 2px'}
			])) : _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[]));
};
...
var _user$project$Port$textSearch = _elm_lang$core$Native_Platform.outgoingPort(
	'textSearch',
	function (v) {
		return v;
	});
...
var _user$project$Port$resetKeysBeingTyped = _elm_lang$core$Native_Platform.incomingPort('resetKeysBeingTyped', _elm_lang$core$Json_Decode$string);
var _user$project$Port$pause = _elm_lang$core$Native_Platform.outgoingPort(
	'pause',
	function (v) {
		return v;
	});
var _user$project$Port$lookupAlbumArt = _elm_lang$core$Native_Platform.outgoingPort(
	'lookupAlbumArt',
	function (v) {
		return v;
	});
...
var _user$project$Helpers$generateIdList = F2(
	function (len, list) {
		return _elm_lang$core$Native_Utils.eq(len, 0) ? list : A2(
			_elm_lang$core$List_ops['::'],
			len,
			A2(_user$project$Helpers$generateIdList, len - 1, list));
	});
...
var _user$project$Audio$previousSong = function (model) {
	var shouldReset = _elm_lang$core$Native_Utils.eq(model.currentSong, 0);
	if (shouldReset) {
		var newCurrentSong = _elm_lang$core$Array$length(model.queue.array) - 1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{currentSong: newCurrentSong}),
			_1: A2(_user$project$Helpers$lookupAlbumArt, newCurrentSong, model.queue.array)
		};
	} else {
...
var _user$project$Audio$nextSong = function (model) {
	var shouldReset = _elm_lang$core$Native_Utils.cmp(
		model.currentSong,
		_elm_lang$core$Array$length(model.queue.array) - 1) > -1;
	if (shouldReset) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{currentSong: 0}),
			_1: A2(_user$project$Helpers$lookupAlbumArt, 0, model.queue.array)
		};
	} else {
		var newCurrentSong = model.currentSong + 1;
		return {
...
var _user$project$Audio$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NextSong') {
			return _user$project$Audio$nextSong(model);
		} else {
			return _user$project$Audio$previousSong(model);
		}
	});
var _user$project$Audio$init = function (id) {
	return id;
};
var _user$project$Audio$PreviousSong = {ctor: 'PreviousSong'};
...
var _user$project$Audio$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('audio-view-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('audio-player-container'),
								_elm_lang$html$Html_Attributes$src(
								_user$project$Audio$streamPath(model)),
								_elm_lang$html$Html_Attributes$type$('audio/mp3'),
								_elm_lang$html$Html_Attributes$controls(true),
	...
	function (model, maybeDragPos, data) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$MyStyle$dragging, maybeDragPos, model.isSelected)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(data.title)
...
var _user$project$Item$MouseLeave = {ctor: 'MouseLeave'};
var _user$project$Item$MouseEnter = {ctor: 'MouseEnter'};
var _user$project$Item$commonAttrubutes = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Events$onMouseDown(_user$project$Item$ItemClicked),
			_elm_lang$html$Html_Events$onDoubleClick(_user$project$Item$ItemDoubleClicked),
			_elm_lang$html$Html_Events$onMouseEnter(_user$project$Item$MouseEnter),
			_elm_lang$html$Html_Events$onMouseLeave(_user$project$Item$MouseLeave),
			_user$project$MyStyle$isSelected(model.isSelected),
			_user$project$MyStyle$mouseOver(model.isMouseOver)
		]);
};
var _user$project$Item$browserItemView = F3(
		...
		if (_p0.ctor === 'Song') {
			return A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('song-item')
						]),
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('group-item'),
...
var _user$project$Item$queueItemView = F4(
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('song-item'),
							_user$project$MyStyle$currentSong(isCurrentSong)
						]),
					_user$project$Item$commonAttrubutes(model)),
				A3(_user$project$Item$commonHtml, model, maybeDragPos, _p1._0));
		} else {
			return A2(
				_elm_lang$html$Html$li,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('This should never happen')
					]));
		}
	});
var _user$project$Item$Clicked = {ctor: 'Clicked'};
var _user$project$Item$MouseEntered = {ctor: 'MouseEntered'};
		...
		switch (_p2.ctor) {
			case 'MouseEnter':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isMouseOver: true}),
					_1: _elm_lang$core$Maybe$Just(_user$project$Item$MouseEntered)
				};
			case 'MouseLeave':
				return {
					ctor: '_Tuple2',
			...
			case 'ItemClicked':
				return {
					...
					_1: _elm_lang$core$Maybe$Just(_user$project$Item$Clicked)
				};
			case 'ItemDoubleClicked':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_user$project$Item$DoubleClicked)
				};
			default:
				return {
					ctor: '_Tuple2',
	...
	F2(
		function (_p1, _p0) {
			...
			if (_p4.ctor === 'Group') {
				var _p5 = _p3._1.data;
				if (_p5.ctor === 'Group') {
					return A2(_elm_lang$core$Basics$compare, _p4._0.title, _p5._0.title);
				} else {
...
var _user$project$SortSongs$byAlbumAndTrack = _elm_lang$core$List$sortWith(
	F2(
		function (item1, item2) {
			...
			if (_p6.ctor === 'Song') {
				...
				if (_p7.ctor === 'Song') {
					var _p9 = _p7._0;
					var _p8 = A2(_elm_lang$core$Basics$compare, _p10.album, _p9.album);
					if (_p8.ctor === 'EQ') {
						return A2(_elm_lang$core$Basics$compare, _p10.track, _p9.track);
					} else {
						return _p8;
					}
				} else {
...
var _user$project$Browser$itemToHtml = F2(
	function (maybePos, _p0) {
		...
		return A2(
			...
			A3(_user$project$Item$browserItemView, maybePos, _p2, _p1._1));
	});
var _user$project$Browser$view = F2(
	function (maybePos, model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id('file-view-container'),
					_elm_lang$html$Html_Attributes$class('scroll-box'),
					_elm_lang$html$Html_Events$onMouseEnter(_user$project$Browser$MouseEnter),
					_elm_lang$html$Html_Events$onMouseLeave(_user$project$Browser$MouseLeave),
					_user$project$MyStyle$mouseOver(model.isMouseOver)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
			...
			case 'ItemMsg':
				...
				if (_p4.ctor === 'Just') {
					...
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							items: A3(_elm_lang$core$Dict$insert, _p8, item$, model.items)
						});
					var _p6 = itemCmd;
					_v3_2:
					do {
						if (_p6.ctor === 'Just') {
							switch (_p6._0.ctor) {
								case 'DoubleClicked':
									var _p7 = item$.data;
									if (_p7.ctor === 'Group') {
										var newItems = _user$project$Helpers$makeSongItemDictionary(_p7._0.songs);
										return {
											ctor: '_Tuple2',
											_0: _elm_lang$core$Native_Utils.update(
												model$,
										...
										return {
											...
											_1: _elm_lang$core$Maybe$Just(
												_user$project$Browser$AddSong(item$))
										};
									}
								case 'Clicked':
									if (isShiftDown) {
										...
										var itemsWithOneSelected = A3(_elm_lang$core$Dict$insert, _p8, item$, cleanItems);
										return {
											ctor: '_Tuple2',
											_0: _elm_lang$core$Native_Utils.update(
												model,
...
var _user$project$Queue$resetQueue = _elm_lang$core$Array$map(
	function (_p0) {
		return _elm_lang$core$Basics$fst(
			A2(_user$project$Item$update, _user$project$Item$Reset, _p0));
	});
...
var _user$project$Queue$Drop = F2(
	function (a, b) {
		return {ctor: 'Drop', _0: a, _1: b};
	});
var _user$project$Queue$ItemMsg = F2(
	function (a, b) {
		return {ctor: 'ItemMsg', _0: a, _1: b};
	});
var _user$project$Queue$itemToHtml = F3(
	function (maybePos, currentSong, _p1) {
		var _p2 = _p1;
		var _p3 = _p2._0;
		return A2(
			_elm_lang$html$Html_App$map,
			_user$project$Queue$ItemMsg(_p3),
			A4(
				_user$project$Item$queueItemView,
				maybePos,
				_elm_lang$core$Native_Utils.eq(_p3, currentSong),
				_elm_lang$core$Basics$toString(_p3),
				_p2._1));
	});
var _user$project$Queue$MouseLeave = {ctor: 'MouseLeave'};
var _user$project$Queue$MouseEnter = {ctor: 'MouseEnter'};
var _user$project$Queue$view = F3(
	function (maybePos, currentSong, model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id('queue-view-container'),
					_elm_lang$html$Html_Attributes$class('scroll-box'),
					_elm_lang$html$Html_Events$onMouseEnter(_user$project$Queue$MouseEnter),
					_elm_lang$html$Html_Events$onMouseLeave(_user$project$Queue$MouseLeave),
					_user$project$MyStyle$mouseOver(model.mouseOver)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _user$project$Queue$UpdateCurrentSong = function (a) {
	return {ctor: 'UpdateCurrentSong', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'ItemMsg':
				...
				if (_p5.ctor === 'Just') {
					var _p6 = A2(_user$project$Item$update, _p4._1, _p5._0);
					var item$ = _p6._0;
					var itemCmd = _p6._1;
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							array: A3(_elm_lang$core$Array$set, _p8, item$, model.array)
						});
					var _p7 = itemCmd;
					_v3_2:
					do {
							...
							switch (_p7._0.ctor) {
								...
								case 'DoubleClicked':
									return {
										...
										_0: model$,
										_1: _elm_lang$core$Maybe$Just(
											_user$project$Queue$UpdateCurrentSong(_p8))
									};
								default:
									break _v3_2;
							}
			...
			case 'Drop':
				...
				var newQueueIndex = (_elm_lang$core$Native_Utils.cmp(_p9, model.mouseOverItem) > 0) ? (_p9 + _elm_lang$core$Array$length(newArrayItems)) : _p9;
				var right = A3(
				...
				return {
					...
					_1: _elm_lang$core$Maybe$Just(
						_user$project$Queue$UpdateCurrentSong(newQueueIndex))
				};
			case 'Reorder':
				var _p15 = _p4._0;
				var maybeIndexedItemToReorder = _elm_lang$core$List$head(
					A2(
						...
						function (_p10) {
							var _p11 = _p10;
							return _p11._1.isSelected;
						},
						_elm_lang$core$Array$toIndexedList(model.array)));
				var _p12 = maybeIndexedItemToReorder;
				if (_p12.ctor === 'Just') {
					var _p14 = _p12._0._0;
					var newQueueIndex = ((_elm_lang$core$Native_Utils.cmp(_p15, _p14) > 0) && (_elm_lang$core$Native_Utils.cmp(_p15, model.mouseOverItem) < 0)) ? (_p15 - 1) : (((_elm_lang$core$Native_Utils.cmp(_p15, _p14) < 0) && (_elm_lang$core$Native_Utils.cmp(_p15, model.mouseOverItem) > 0)) ? (_p15 + 1) : _p15);
					...
					var reorderedQueue = A2(
						_elm_lang$core$Array$append,
						A2(_elm_lang$core$Array$push, _p12._0._1, left),
						right);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				...
				var maybeItemToRemove = _elm_lang$core$List$head(
					A2(
						...
						function (_p16) {
							var _p17 = _p16;
							return _p17._1.isSelected;
						},
						_elm_lang$core$Array$toIndexedList(model.array)));
				var _p18 = maybeItemToRemove;
				if (_p18.ctor === 'Just') {
					var _p19 = _p18._0._0;
					var array$ = A2(
						_elm_lang$core$Array$append,
						A3(_elm_lang$core$Array$slice, 0, _p19, model.array),
						A3(_elm_lang$core$Array$slice, _p19 + 1, -1, model.array));
					var newQueueIndex = (_elm_lang$core$Native_Utils.cmp(_p19, _p20) < 0) ? (_p20 - 1) : _p20;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								array: _user$project$Queue$resetQueue(array$)
							}),
						_1: _elm_lang$core$Maybe$Just(
							_user$project$Queue$UpdateCurrentSong(newQueueIndex))
					};
...
var _user$project$Player$currentMouseLocation = function (model) {
...
var _user$project$Player$urlUpdate = F2(
	function (newPath, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Player$initialModel = {
	currentSong: 0,
	queue: {array: _elm_lang$core$Array$empty, mouseOver: false, mouseOverItem: 1},
...
var _user$project$Player$fromUrl = function (url) {
	return A2(_elm_lang$core$String$dropLeft, 1, url);
};
var _user$project$Player$urlParser = _elm_lang$navigation$Navigation$makeParser(
	function (_p0) {
		return _user$project$Player$fromUrl(
			function (_) {
				return _.hash;
			}(_p0));
	});
var _user$project$Player$toUrl = function (path) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#/',
		A2(_elm_lang$core$Debug$log, 'to_url', path));
};
var _user$project$Player$init = function (s) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Player$initialModel,
		_1: _elm_lang$navigation$Navigation$newUrl(
			_user$project$Player$toUrl('nothing'))
	};
};
var _user$project$Player$ResetKeysBeingTyped = function (a) {
	return {ctor: 'ResetKeysBeingTyped', _0: a};
};
var _user$project$Player$CreateDatabase = {ctor: 'CreateDatabase'};
var _user$project$Player$DestroyDatabase = {ctor: 'DestroyDatabase'};
var _user$project$Player$TextSearch = function (a) {
	return {ctor: 'TextSearch', _0: a};
};
var _user$project$Player$UpdateAlbumArt = function (a) {
	return {ctor: 'UpdateAlbumArt', _0: a};
};
var _user$project$Player$GroupBy = function (a) {
	return {ctor: 'GroupBy', _0: a};
};
var _user$project$Player$navigationView = A2(
	_elm_lang$html$Html$ul,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$id('navigation-view-container')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Player$GroupBy('album'))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Group By album')
				])),
			A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$Player$GroupBy('artist'))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Group By artist')
				])),
			A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$Player$GroupBy('song'))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Group By song')
				])),
			A2(
			_elm_lang$html$Html$input,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onInput(_user$project$Player$TextSearch)
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(_user$project$Player$CreateDatabase)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Create Database')
				])),
			A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(_user$project$Player$DestroyDatabase)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Destroy Database')
				]))
		]));
var _user$project$Player$MouseMoves = function (a) {
	return {ctor: 'MouseMoves', _0: a};
};
var _user$project$Player$MouseUps = function (a) {
	return {ctor: 'MouseUps', _0: a};
};
var _user$project$Player$MouseDowns = function (a) {
	return {ctor: 'MouseDowns', _0: a};
};
var _user$project$Player$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Player$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _user$project$Player$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Port$resetKeysBeingTyped(_user$project$Player$ResetKeysBeingTyped),
				_user$project$Port$updateAlbumArt(_user$project$Player$UpdateAlbumArt),
				_elm_lang$keyboard$Keyboard$ups(_user$project$Player$KeyUp),
				_elm_lang$keyboard$Keyboard$downs(_user$project$Player$KeyDown),
				_elm_lang$mouse$Mouse$downs(_user$project$Player$MouseDowns),
				_elm_lang$mouse$Mouse$ups(_user$project$Player$MouseUps),
				_elm_lang$mouse$Mouse$moves(_user$project$Player$MouseMoves)
			]));
};
var _user$project$Player$UpdateGroups = function (a) {
	return {ctor: 'UpdateGroups', _0: a};
};
var _user$project$Player$UpdateSongsFail = function (a) {
	return {ctor: 'UpdateSongsFail', _0: a};
};
var _user$project$Player$UpdateSongs = function (a) {
	return {ctor: 'UpdateSongs', _0: a};
};
var _user$project$Player$update = F2(
	function (action, model) {
		var _p1 = A2(_elm_lang$core$Debug$log, 'action ', action);
		switch (_p1.ctor) {
			case 'KeyUp':
							...
							function (_p2) {
								...
								return A2(
									...
									_elm_lang$core$String$toUpper(
										_user$project$Helpers$getItemTitle(_p3._1)));
							},
					...
					if (_p4.ctor === 'Just') {
						return {
							...
							_1: _user$project$Port$scrollToElement(
								A2(_elm_lang$core$Basics_ops['++'], 'group-item-', _p4._0._0))
						};
					} else {
						return {
							ctor: '_Tuple2',
				...
				switch (_p5) {
					...
					default:
						return textSearchUpdateHelper(_p5);
				}
			case 'KeyDown':
				var _p6 = _p1._0;
				if (_p6 === 16) {
			...
			case 'NavigationBack':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$back(
						A2(_elm_lang$core$Debug$log, 'nav back ', 1))
				};
			case 'AudioMsg':
				return A2(_user$project$Audio$update, _p1._0, model);
			case 'QueueMsg':
				var _p7 = A2(_user$project$Queue$update, _p1._0, model.queue);
				var queue$ = _p7._0;
				var queueCmd = _p7._1;
				var _p8 = queueCmd;
				if (_p8.ctor === 'Just') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{queue: queue$, currentSong: _p9}),
						_1: A2(_user$project$Helpers$lookupAlbumArt, _p9, queue$.array)
					};
				} else {
					return {
						ctor: '_Tuple2',
			...
			case 'BrowserMsg':
				var _p10 = A3(_user$project$Browser$update, _p1._0, model.isShiftDown, model.browser);
				var browser$ = _p10._0;
				var browserCmd = _p10._1;
				var _p11 = browserCmd;
				if ((_p11.ctor === 'Just') && (_p11._0.ctor === 'AddSong')) {
					var _p13 = _p11._0._0;
					var _p12 = _p13.data;
					if (_p12.ctor === 'Song') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								...
								{
									browser: browser$,
									queue: _elm_lang$core$Basics$fst(
										A2(
			...
			case 'UpdateSongs':
				var browser = A2(_elm_lang$core$Debug$log, 'browser', _user$project$Browser$initialModel);
				var browser$ = _elm_lang$core$Native_Utils.update(
					browser,
					{
						items: _user$project$Helpers$makeSongItemDictionary(_p1._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'UpdateGroups':
				...
				var browser$ = _elm_lang$core$Native_Utils.update(
					browser,
					{
						items: _user$project$Helpers$makeGroupItemDictionary(_p1._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							dragStart: _elm_lang$core$Maybe$Just(
								_user$project$Player$currentMouseLocation(model))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseUps':
				var model$ = _elm_lang$core$Native_Utils.update(
					model,
					{dragStart: _elm_lang$core$Maybe$Nothing});
				var dragEnd = _user$project$Player$currentMouseLocation(model);
				var maybeDragStart = model.dragStart;
				var _p14 = maybeDragStart;
				_v8_2:
				do {
					if (_p14.ctor === 'Just') {
						switch (_p14._0.ctor) {
							case 'BrowserWindow':
								...
								if (_p15.ctor === 'QueueWindow') {
													...
													var newItems = A2(
														...
														function (song) {
															return {
																isSelected: false,
																isMouseOver: false,
																data: _user$project$MyModels$Song(song)
															};
														},
														_p16._0.songs);
													return A2(_elm_lang$core$Basics_ops['++'], newItems, acc);
												} else {
													return A2(_elm_lang$core$List_ops['::'], item, acc);
												}
											}),
										_elm_lang$core$Native_List.fromArray(
											[]),
									...
									var _p17 = A2(
										_user$project$Queue$update,
										A2(_user$project$Queue$Drop, itemsToDrop, model.currentSong),
										model.queue);
									var queue$ = _p17._0;
									var queueCmd = _p17._1;
									var _p18 = queueCmd;
									if (_p18.ctor === 'Just') {
										var _p19 = _p18._0._0;
										return {
											...
											_0: _elm_lang$core$Native_Utils.update(
												...
												{
													queue: queue$,
													browser: _elm_lang$core$Basics$fst(
														A3(_user$project$Browser$update, _user$project$Browser$Reset, false, model.browser)),
													currentSong: _p19
												}),
											_1: A2(_user$project$Helpers$lookupAlbumArt, _p19, queue$.array)
										};
									} else {
										return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
									}
							...
							case 'QueueWindow':
								...
								if (_p20.ctor === 'QueueWindow') {
									var _p21 = A2(
										_user$project$Queue$update,
										_user$project$Queue$Reorder(model.currentSong),
										model.queue);
									var queue$ = _p21._0;
									var queueCmd = _p21._1;
									var _p22 = queueCmd;
									if (_p22.ctor === 'Just') {
										var _p23 = _p22._0._0;
										return {
											...
											_0: _elm_lang$core$Native_Utils.update(
												model$,
												{queue: queue$, currentSong: _p23}),
											_1: A2(_user$project$Helpers$lookupAlbumArt, _p23, queue$.array)
										};
									} else {
										return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
									}
									...
									var _p24 = A2(
										_user$project$Queue$update,
										_user$project$Queue$Remove(model.currentSong),
										model.queue);
									var queue$ = _p24._0;
									var queueCmd = _p24._1;
									var _p25 = queueCmd;
									if (_p25.ctor === 'Just') {
										var _p26 = _p25._0._0;
										return {
											...
											_0: _elm_lang$core$Native_Utils.update(
												model$,
												{queue: queue$, currentSong: _p26}),
											_1: A2(_user$project$Helpers$lookupAlbumArt, _p26, queue$.array)
										};
									} else {
										return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
									}
				...
				switch (_p27) {
					case 'song':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$ApiHelpers$fetchAllSongs, _user$project$Player$UpdateSongsFail, _user$project$Player$UpdateSongs)
						};
					case 'album':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$ApiHelpers$fetchAllAlbums, _user$project$Player$UpdateSongsFail, _user$project$Player$UpdateGroups)
						};
					case 'artist':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$ApiHelpers$fetchAllArtists, _user$project$Player$UpdateSongsFail, _user$project$Player$UpdateGroups)
						};
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'TextSearch':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Port$textSearch(_p1._0)
				};
			case 'CreateDatabase':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
...
var _user$project$Player$BrowserMsg = function (a) {
	return {ctor: 'BrowserMsg', _0: a};
};
var _user$project$Player$browserView = function (model) {
	var maybeMousePos = function () {
		var _p28 = model.dragStart;
		if ((_p28.ctor === 'Just') && (_p28._0.ctor === 'BrowserWindow')) {
	...
	return A2(
		_elm_lang$html$Html_App$map,
		_user$project$Player$BrowserMsg,
		A2(_user$project$Browser$view, maybeMousePos, model.browser));
};
var _user$project$Player$QueueMsg = function (a) {
	return {ctor: 'QueueMsg', _0: a};
};
var _user$project$Player$queueView = function (model) {
	var maybeMousePos = function () {
		var _p29 = model.dragStart;
		if ((_p29.ctor === 'Just') && (_p29._0.ctor === 'QueueWindow')) {
			return _elm_lang$core$Maybe$Just(model.currentMousePos);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	...
	return A2(
		_elm_lang$html$Html_App$map,
		_user$project$Player$QueueMsg,
		A3(_user$project$Queue$view, maybeMousePos, model.currentSong, model.queue));
};
var _user$project$Player$AudioMsg = function (a) {
	return {ctor: 'AudioMsg', _0: a};
};
var _user$project$Player$audioPlayer = function (model) {
	var _p30 = A2(_elm_lang$core$Array$get, model.currentSong, model.queue.array);
	if (_p30.ctor === 'Just') {
		var _p31 = _p30._0.data;
		if (_p31.ctor === 'Song') {
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Player$AudioMsg,
				_user$project$Audio$view(_p31._0.id));
		} else {
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Player$AudioMsg,
				_user$project$Audio$view(0));
		}
	} else {
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$Player$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('banner')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Player$audioPlayer(model),
				_user$project$Player$navigationView,
				_user$project$Player$browserView(model),
				_user$project$Player$queueView(model),
				_user$project$AlbumArt$view(model.albumArt)
			]));
};
var _user$project$Player$main = {
	main: A2(
		_elm_lang$navigation$Navigation$program,
		_user$project$Player$urlParser,
		{init: _user$project$Player$init, view: _user$project$Player$view, update: _user$project$Player$update, urlUpdate: _user$project$Player$urlUpdate, subscriptions: _user$project$Player$subscriptions})
};
var _user$project$Player$NavigationBack = {ctor: 'NavigationBack'};

var Elm = {};
Elm['Player'] = Elm['Player'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Player'], 'Player', typeof _user$project$Player$main === 'undefined' ? null : _user$project$Player$main);
